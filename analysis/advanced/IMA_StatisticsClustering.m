% calling StatisticsClustering routines.

SaveDir = 'C:\Users\imadams\OneDrive - University of New Mexico Health Sciences Center\Desktop\Hek ALFA-EGFR (L858R) BaGoL\Clustering';
% if ~isfolder(SaveDir)
